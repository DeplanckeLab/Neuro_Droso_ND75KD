...
output_figure_prefix <- "./figures/Figure_6G/Martirosyan_neurons_"
```
...
plot.boxplot.aucell(data.seurat@meta.data, "AUC_UPR_93_REACTOME", "IDENT", 2, 3)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "AUC_UPR_93_REACTOME", "IDENT", "sex", pwidth = 10)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "AUC_UPR_93_REACTOME", "IDENT", "clinicalDiag", pwidth = 10)
```