...
output_figure_prefix <- "./figures/Figure_2EK/Boxplot_ND75KD_vs_Control_all_annotations_expression_"
```
...
```{r}
#data.seurat$annotation_clusters <- paste0(data.seurat$seurat_clusters, ": ", data.seurat$annotation)
#data.seurat$annotation_clusters <- factor(data.seurat$annotation_clusters, levels = names(annotatedClusterPalette))
```
...
# Save
ggsave(p, filename = paste0(output_figure_prefix, "_ordered_boxplot_",gene,".pdf"), width = 15, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_ordered_boxplot_",gene,".png"), width = 15, height = 5, dpi = 1000, bg = 'white')
