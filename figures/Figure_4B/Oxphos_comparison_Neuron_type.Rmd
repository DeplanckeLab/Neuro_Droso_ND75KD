...
annotationClustersPalette <- list(`0`="#76C15D", `1`="#539DA4", `2`="#B15928", `glutamatergic neuron`="#78B69A", `4`="#46A93A", `5`="#EA4041", `epithelial cell`="#E42123", `transmedullary Y neuron TmY8`="#A5D880", `cone cell`="#FDB35B", `photoreceptor cell`="#F29A94", `photoreceptor cell`="#449F35", `cone cell`="#F98F8F", `cholinergic neuron`="#2F83AF", `skeletal muscle of head`="#A6CEE3", `gabaergic neuron`="#84B8D7", `15`="#85C969", `medullary intrinsic neuron Mi4`="#DBA08D", `17`="#C09B79", `outer photoreceptor cell`="#F68724", `epithelial cell`="#9CCF90", `skeletal muscle of head`="#2078B4", `gabaergic neuron`="#5D9E43", `22`="#E7392B", `23`="#6D4199", `cone cell`="#E73132", `T neuron T4/T5`="#E42521", `OPN neuron`="#F89F5F", `kenyon cell`="#37A22F", `outer photoreceptor cell`="#8AC395", `olfactory receptor neuron`="#D99B86", `30`="#63A3CB", `31`="#9774B6", `gamma kenyon cell`="#418EC0", `33`="#CEADC2", `distal medullary amacrine neuron Dm3`="#4190AA", `serotonergic neuron`="#F6807F", `lamina monopolar neuron L1 + L2`="#A79C6B", `adult reticular neuropil associated glial cell`="#F1764A", `epithelial cell`="#5298C5", `adult optic chiasma glial cell`="#95D074", `40`="#F37070", `epithelial cell`="#A48999", `tm5ab`="#8F9D5E", `43`="#EEE999", `T neuron T3`="#AEDC8A", `45`="#FE8B16", `46`="#66A99F", `pigment cell`="#EF8D3E", `epithelial cell`="#56B146", `lobular columnar neuron LC12`="#FE9324", `centrifugal neuron C2`="#BA9FCC", `Poxn neuron`="#FE8408", `transmedullary Y neuron TmY5a`="#FEFD97", `lamina monopolar neuron L4`="#F06060", `photoreceptor-like cell`="#E89458", `lamina wide-field 2 neuron`="#EE6240", `columnar neuron T1`="#EB4D36", `adult brain cell body glial cell`="#FE9B31", `dopaminergic neuron`="#769D50", `lamina monopolar neuron L3`="#7F5999", `transmedullary neuron Tm1`="#66B952", `medullary intrinsic neuron Mi1`="#FC8109", `medullary intrinsic neuron Mi4`="#95C3DD", `transmedullary neuron Tm9`="#73AED1", `adult brain perineurial glial cell`="#DBD199", `skeletal muscle of head`="#C6AED3", `adult lamina epithelial/marginal glial cell`="#D5A7A8", `transmedullary neuron Tm20`="#E29A73", `hemocyte`="#8B65AE", `adult optic chiasma glial cell`="#3183BA", `70`="#AF91C5", `transmedullary neuron Tm2`="#FBB369", `lamina monopolar neuron L5`="#FDA33F", `glutamatergic neuron`="#C9B999", `epithelial cell`="#FDAB4D", `cholinergic neuron`="#7F57A7", `centrifugal neuron C3`="#A382BD", `77`="#927199", `distal medullary amacrine neuron Dm9`="#F48B54", `distal medullary amacrine neuron Dm8`="#E1BF6D", `medullary intrinsic neuron Mi15`="#FDBB68", `proximal medullary amacrine neuron Pm4`="#ED5051", `optic lobe associated cortex glial cell`="#F4E889", `83`="#D7AB5F", `OPN neuron`="#C48243", `85`="#7348A0", `86`="#EAD47B", `87`="#B7A199", `88`="#CD9651", `transmedullary Y neuron TmY14`="#BA6D35")
...
output_figure_prefix <- "./figures/Figure_4B/"
```
...
## Boxplot (Control + ND-75 KD)

```{r, fig.width=2,fig.height=5}
# Extracting the relevant metadata
boxplot_data <- as.data.frame(data.seurat@meta.data)

# Plot
p <- ggplot(boxplot_data, aes(x = Neuron_category, y = AUC_OXPHOS_117_Flybase, fill = Neuron_category)) +
  geom_boxplot() +
  labs(x = NULL, y = "AUC_OXPHOS_117_Flybase") +
  #theme_minimal() + theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme_minimal() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  #scale_fill_manual(values = annotatedClusterPalette) +
  scale_fill_manual(values = steinPalette) +
  NoLegend()
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_by_neuron_category.pdf"), width = 2, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_by_neuron_category.png"), width = 2, height = 5, dpi = 1000, bg = 'white')
```

# Statistical analysis

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Central Brain A"], boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Central Brain B"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Central Brain A"], boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Optic lobe"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Central Brain A"], boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Glia"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Central Brain B"], boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Optic lobe"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Central Brain B"], boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Glia"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Optic lobe"], boxplot_data$AUC_OXPHOS_117_Flybase[boxplot_data$Neuron_category == "Glia"])
stats
```
...
# Perform pairwise Wilcoxon tests and annotate p-values
p <- ggplot(boxplot_data, aes(x = Neuron_category, y = AUC_OXPHOS_117_Flybase, fill = Neuron_category)) +
  geom_boxplot() +
  labs(x = NULL, y = "AUC_OXPHOS_117_Flybase") +
  theme_minimal() +
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_by_neuron_category_with_signif.pdf"), width = 3, height = 8, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_by_neuron_category_with_signif.png"), width = 3, height = 8, dpi = 1000, bg = 'white')
```

## Using the 68-gene pathway
...
# Plot
p <- ggplot(boxplot_data, aes(x = Neuron_category, y = AUC_OXPHOS_68_Porcelli, fill = Neuron_category)) +
  geom_boxplot() +
  labs(x = NULL, y = "AUC_OXPHOS_68_Porcelli") +
  #theme_minimal() + theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  theme_minimal() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +
  #scale_fill_manual(values = annotatedClusterPalette) +
  scale_fill_manual(values = steinPalette) +
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_68_by_neuron_category.pdf"), width = 2, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_68_by_neuron_category.png"), width = 2, height = 5, dpi = 1000, bg = 'white')
```

# Statistical analysis

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Central Brain A"], boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Central Brain B"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Central Brain A"], boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Optic lobe"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Central Brain A"], boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Glia"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Central Brain B"], boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Optic lobe"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Central Brain B"], boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Glia"])
stats
```

```{r}
stats <- wilcox.test(boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Optic lobe"], boxplot_data$AUC_OXPHOS_68_Porcelli[boxplot_data$Neuron_category == "Glia"])
stats
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_68_by_neuron_category_with_signif.pdf"), width = 3, height = 8, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_68_by_neuron_category_with_signif.png"), width = 3, height = 8, dpi = 1000, bg = 'white')
```