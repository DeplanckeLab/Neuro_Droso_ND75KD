...
output_figure_prefix <- "./figures/Figure_S6E/Martirosyan_"
```
...
p <- FeaturePlot(data.seurat, reduction = "UMAP", features = "AUC_UPR_93_REACTOME", raster = FALSE, pt.size = 1) + theme_void()
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_AUC_UPR_93_REACTOME.pdf"), plot = p, width = 5, height = 5, bg = "white")
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_AUC_UPR_93_REACTOME.png"), plot = p, width = 5, height = 5, dpi = 1000, bg = "white")
p
```
