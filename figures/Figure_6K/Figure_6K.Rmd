...
output_figure_prefix <- "./figures/Figure_6K/Kellis_"
```
...
p <- FeaturePlot(data.seurat, reduction = "umap", features = "AUC_OXPHOS_119_KEGG", raster = FALSE) + theme_void() + theme(plot.title = element_blank()) + NoLegend()
ggsave(paste0(output_figure_prefix, "UMAP_Excitatory.neurons.only_AUC_OXPHOS_119_KEGG.pdf"), plot = p, width = 5, height = 5, bg = "white")
ggsave(paste0(output_figure_prefix, "UMAP_Excitatory.neurons.only_AUC_OXPHOS_119_KEGG.png"), plot = p, width = 5, height = 5, dpi = 1000, bg = "white")
p
```
