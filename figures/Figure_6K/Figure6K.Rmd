...
plot.boxplot.aucell(data.seurat@meta.data, "AUC_UPR_92", "cell_type_high_resolution", pwidth = 5, pheight = 4, filename = paste0(output_figure_prefix, "AUC_UPR_92_AUCell_ordered_boxplot_cell_type_high_resolution_Excitatory.neurons-only"))
```
