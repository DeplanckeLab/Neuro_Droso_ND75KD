...
output_figure_prefix <- "./figures/Figure_6F/Martirosyan_neurons_"
```
...
data.seurat$HSPA8 <- data.seurat@assays$RNA@data["HSPA8",]
plot.boxplot.aucell(data.seurat@meta.data, "HSPA8", "IDENT", 2, 3)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "HSPA8", "IDENT", "sex", pwidth = 10)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "HSPA8", "IDENT", "clinicalDiag", pwidth = 10)
```