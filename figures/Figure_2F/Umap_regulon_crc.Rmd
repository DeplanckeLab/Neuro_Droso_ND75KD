...
output_figure_prefix <- "./figures/Figure_2F/UMAP_Regulon_crc"
```
...
p <- FeaturePlot(data.seurat, reduction = "SCENICbinarizedumap", pt.size = 0.5, features = "SCENIC_crc_activating_regulon", order = T) + 
