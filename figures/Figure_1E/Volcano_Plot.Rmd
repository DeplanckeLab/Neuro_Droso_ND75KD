...
de_file <- "./figures/Figure_1DE/List_DE_ND75KD_Control_all_annotations_overall_bulk.tsv"
...
# Genes to annotate
genes_to_label <- c("Ldh", "Obp99b", "ND-75", "FBti0063565", "Dro", "Dgp-1", "MFS3", "AttC", "y", "Arc1", "TotA", "Cyp4e3", "Mtk")
