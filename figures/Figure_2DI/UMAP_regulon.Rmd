...
output_figure_prefix <- "./figures/Figure_2B/UMAP_Regulon"
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_sima_regulon.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_sima_regulon.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_sima_regulon_binarized.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_sima_regulon_binarized.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_crc_regulon.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_crc_regulon.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_crc_regulon_binarized.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_crc_regulon_binarized.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_crc_regulon_binarized_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_crc_regulon_binarized_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```
