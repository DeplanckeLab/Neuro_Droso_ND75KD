...
output_figure_prefix <- "./figures/Figure_S6C/Martirosyan_"
```
...
p <- FeaturePlot(data.seurat, reduction = "UMAP", features = "HSP90AA1", raster = FALSE, pt.size = 1) + theme_void()
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_HSP90AA1.pdf"), plot = p, width = 5, height = 5, bg = "white")
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_HSP90AA1.png"), plot = p, width = 5, height = 5, dpi = 1000, bg = "white")
p
```
