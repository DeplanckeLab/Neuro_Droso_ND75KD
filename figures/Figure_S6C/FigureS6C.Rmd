...
output_figure_prefix <- "./figures/Figure_S6C/Kellis_"
```
...
plot.boxplot.aucell.2(data.seurat@meta.data, "AUC_UPR_92", "cell_type_high_resolution", "pathAD", pwidth = 10, pheight = 5, filename = paste0(output_figure_prefix, "AUC_UPR_92_AUCell_ordered_boxplot_pathAD_by_cell_type_high_resolution_Excitatory.neurons-only"))
```
