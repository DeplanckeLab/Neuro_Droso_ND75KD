...
output_figure_prefix <- "./figures/Figure_5X/"
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_by_neuron_category_with_signif.pdf"), width = 2, height = 7, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_by_neuron_category_with_signif.png"), width = 2, height = 7, dpi = 1000, bg = 'white')
```