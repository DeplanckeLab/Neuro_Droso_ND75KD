...
description: "Figure - Correlated regulon activity with Oxphos score, across all genes"
...
```{r}
# Write the results
fwrite(correlation_data, file = paste0(output_file_prefix, "regulon_activity_correlation_OXPHOS_68_Porcelli_CTRL.tsv"), quote = F, sep = "\t", row.names = F, col.names = T)
```
