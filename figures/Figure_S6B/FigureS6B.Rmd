...
output_figure_prefix <- "./figures/Figure_S6B/Martirosyan_"
```
...
p <- FeaturePlot(data.seurat, reduction = "UMAP", features = "AUC_OXPHOS_135_KEGG", raster = FALSE, pt.size = 1) + theme_void()
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_AUC_OXPHOS_135_KEGG.pdf"), plot = p, width = 5, height = 5, bg = "white")
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_AUC_OXPHOS_135_KEGG.png"), plot = p, width = 5, height = 5, dpi = 1000, bg = "white")
p
```
