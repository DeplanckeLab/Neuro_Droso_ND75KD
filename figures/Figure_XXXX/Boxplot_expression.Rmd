...
# Save
ggsave(p, filename = paste0(output_figure_prefix, "ordered_boxplot_",gene,".pdf"), width = 15, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "ordered_boxplot_",gene,".png"), width = 15, height = 5, dpi = 1000, bg = 'white')
...
# Save
ggsave(p, filename = paste0(output_figure_prefix, "scatterplot_",gene,"_expression_correlation.pdf"), width = 15, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "scatterplot_",gene,"_expression_correlation.png"), width = 15, height = 5, dpi = 1000, bg = 'white')
