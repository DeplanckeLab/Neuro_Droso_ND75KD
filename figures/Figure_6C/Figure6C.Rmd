...
```{r}
## Parameters
input_seurat_object <- "./data/Martirosyan_2024/Martirosyan.rds"
output_figure_prefix <- "./figures/Figure_6C/Martirosyan_"
```
...
plot.boxplot.aucell(data.seurat@meta.data, "AUC_OXPHOS_135_KEGG", "IDENT", 2, 3)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "AUC_OXPHOS_135_KEGG", "IDENT", "sex", pwidth = 10)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "AUC_OXPHOS_135_KEGG", "IDENT", "clinicalDiag", pwidth = 10)
```
