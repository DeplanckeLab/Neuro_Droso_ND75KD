...
output_figure_prefix <- "./figures/Figure_6H/Martirosyan_neurons_"
```
...
plot.boxplot.aucell(data.seurat@meta.data, "SCENIC_ATF4_activating_regulon", "IDENT", 2, 3)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "SCENIC_ATF4_activating_regulon", "IDENT", "sex", pwidth = 10)
```

```{r fig.width=4, fig.height=3}
plot.boxplot.aucell.2(data.seurat@meta.data, "SCENIC_ATF4_activating_regulon", "IDENT", "clinicalDiag", pwidth = 10)
```