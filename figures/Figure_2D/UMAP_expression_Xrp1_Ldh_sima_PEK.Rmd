...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_Xrp1.pdf"), width = 5, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_Xrp1.png"), width = 5, height = 5, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_Ldh.pdf"), width = 5, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_Ldh.png"), width = 5, height = 5, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_sima.pdf"), width = 5, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_sima.png"), width = 5, height = 5, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_PEK.pdf"), width = 5, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_PEK.png"), width = 5, height = 5, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_crc.pdf"), width = 5, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_crc.png"), width = 5, height = 5, dpi = 1000, bg = 'white')
```
