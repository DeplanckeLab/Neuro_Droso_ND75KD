...
output_figure_prefix <- "./figures/Figure_2D/"
```
...
## Binarized regulon UMAP plots

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "SCENICbinarizedumap", pt.size = 0.5, features = "Xrp1", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Xrp1.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Xrp1.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Xrp1_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Xrp1_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "SCENICbinarizedumap", pt.size = 0.5, features = "Ldh", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Ldh.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Ldh.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Ldh_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_Ldh_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "SCENICbinarizedumap", pt.size = 0.5, features = "sima", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_sima.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_sima.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_sima_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_sima_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "SCENICbinarizedumap", pt.size = 0.5, features = "PEK", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_PEK.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_PEK.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_PEK_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_PEK_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "SCENICbinarizedumap", pt.size = 0.5, features = "crc", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_crc.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_crc.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_crc_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Regulon_UMAP_Expression_crc_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

## UMAP plots

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "umap_harmony", pt.size = 0.5, features = "Xrp1", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Xrp1.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Xrp1.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Xrp1_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Xrp1_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "umap_harmony", pt.size = 0.5, features = "Ldh", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Ldh.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Ldh.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Ldh_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_Ldh_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "umap_harmony", pt.size = 0.5, features = "sima", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_sima.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_sima.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_sima_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_sima_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "umap_harmony", pt.size = 0.5, features = "PEK", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_PEK.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_PEK.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_PEK_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_PEK_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```

```{r, fig.height = 12, fig.width = 12}
p <- FeaturePlot(data.seurat, reduction = "umap_harmony", pt.size = 0.5, features = "crc", order = T, slot = "data")
p
```

```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_crc.pdf"), width = 12, height = 12, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_crc.png"), width = 12, height = 12, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_crc_small.pdf"), width = 4, height = 4, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "UMAP_Expression_crc_small.png"), width = 4, height = 4, dpi = 1000, bg = 'white')
```
