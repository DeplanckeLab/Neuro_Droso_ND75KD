...
output_figure_prefix <- "./figures/Figure_2H/UMAP_Regulon_Xrp1"
```
...
p <- FeaturePlot(data.seurat, reduction = "SCENICbinarizedumap", pt.size = 0.5, features = "SCENIC_Xrp1_activating_regulon", order = T) + 
