...
median_values <- tapply(boxplot_data$AUC_OXPHOS_117_Flybase, boxplot_data$annotation_clusters, median)
...
# Plot
p <- ggplot(boxplot_data, aes(x = annotation_clusters, y = AUC_OXPHOS_117_Flybase, fill = annotation_clusters)) +
  geom_boxplot() +
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_ordered_boxplot.pdf"), width = 15, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_ordered_boxplot.png"), width = 15, height = 5, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_ordered_boxplot_control-only.pdf"), width = 15, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_ordered_boxplot_control-only.png"), width = 15, height = 5, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_ordered_boxplot_nd75kd-only.pdf"), width = 15, height = 5, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "Oxphos_117_ordered_boxplot_nd75kd-only.png"), width = 15, height = 5, dpi = 1000, bg = 'white')
```