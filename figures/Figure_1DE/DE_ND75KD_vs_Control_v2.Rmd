...
## Save as table
```{r}
fwrite(all.de.genes, file = paste0(output_file_prefix, "_FC1.4_Seuratv5.tsv"), quote = F, row.names = F, col.names = T, sep = "\t")
```
...
ggsave(p, filename = paste0(output_figure_prefix, "_FC1.4_Seuratv5.pdf"), width = 7, height = 6, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_FC1.4_Seuratv5.png"), width = 7, height = 6, dpi = 1000, bg = 'white')
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_gene_FC1.4_Seuratv5.pdf"), width = 25, height = 6, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_gene_FC1.4_Seuratv5.png"), width = 25, height = 6, dpi = 1000, bg = 'white')
```
...
## Save as table
```{r}
fwrite(markers, file = paste0(output_file_prefix, "_overall_FC1.4_Seuratv5.tsv"), quote = F, row.names = T, col.names = T, sep = "\t")
```
...
```{r}
ggsave(p, filename = paste0(output_figure_prefix, "_heatmap-ND75_FC1.4_Seuratv5.pdf"), width = 25, height = 6, bg = "white")
ggsave(p, filename = paste0(output_figure_prefix, "_heatmap-ND75_FC1.4_Seuratv5.png"), width = 25, height = 6, dpi = 1000, bg = 'white')
```