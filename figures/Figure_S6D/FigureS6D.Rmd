...
output_figure_prefix <- "./figures/Figure_S6D/Martirosyan_"
```
...
p <- FeaturePlot(data.seurat, reduction = "UMAP", features = "HSPA8", raster = FALSE, pt.size = 1) + theme_void()
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_HSPA8.pdf"), plot = p, width = 5, height = 5, bg = "white")
ggsave(paste0(output_figure_prefix, "UMAP_neurons.only_HSPA8.png"), plot = p, width = 5, height = 5, dpi = 1000, bg = "white")
p
```
