...
for(annotation in list.annotations){
  data.seurat.tmp <- data.seurat[,data.seurat$annotation == annotation]
  data.seurat.tmp <- SetIdent(data.seurat.tmp, value = "orig.ident")
  markers <- FindMarkers(data.seurat.tmp, ident.1 = "Pan_neuro_ND75KD", ident.2 = "Pan_neuro_control")
