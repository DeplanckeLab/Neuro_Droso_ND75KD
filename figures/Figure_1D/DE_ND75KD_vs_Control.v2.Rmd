...
input_de_results <- "./data/Pan_neuro_integrated_FINAL.rds"
output_figure_prefix <- "./figures/Figure_1D/Test"
```
...
for(annotation in list.annotations){
  markers <- FindMarkers(data.seurat, ident.1 = "Pan_neuro_ND75KD", ident.2 = "Pan_neuro_control", test.use = "wilcox", group.by = "orig.ident", subset.ident = annotation, features = c("ND-75", "Ldh"), min.pct = 0, logfc.threshold = 0)
...
all.de.genes$gene <- factor(all.de.genes$gene, levels = c("ND-75", "Ldh"))
p <- ggplot(all.de.genes, aes(x = annotation, y = avg_log2FC, fill = avg_log2FC > 0)) +
  ...
  labs(x = NULL, y = "log2 Fold Change", fill = NULL)
