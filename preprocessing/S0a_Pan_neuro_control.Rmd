...
input_gene_mapping_path <- "./data/dmel-r6.58_GFP.gtf.all.exon.length.txt"
...
data.seurat <- CreateSeuratObject(Read10X_h5(input_10x_path), project=output_project_name)
...
```{r}
# Read gene mapping
data.gene.mapping <- fread(input_gene_mapping_path, header = T, sep = "\t", data.table = F)
