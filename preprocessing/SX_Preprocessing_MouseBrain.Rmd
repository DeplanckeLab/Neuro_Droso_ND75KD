...
```{r}
## Parameters
input_loom <- "./data/Linnarsson_2018_MouseBrain/l5_all_rev1.loom"
input_Oxphos_133_AUCell_values_path <- "./data/Linnarsson_133_Oxphos_AUCell_auc.tsv"
output_figure_prefix <- "./figures/Figure_SX/"
```
...
# Save metadata for Joe

```{r}
fwrite(data.metadata, file = "./data/Linnarsson_2018_MouseBrain/Linnarsson.metadata.AUCell.Oxphos.tsv", sep = "\t")
```
