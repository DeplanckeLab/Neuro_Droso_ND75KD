---
title: "Emma Pan Neuro (Control + ND75KD) - Preprocessing Kells AD data"
...
```{r}
DimPlot(data.seurat.exc, reduction = "umap", label = T, group.by = "neuronal.exttype")
```
```{r}
DimPlot(data.seurat.exc, reduction = "umap", label = T, group.by = "region")
```
